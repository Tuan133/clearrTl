...
export const translations = {
  vi: {
    ...
    hero: {
      title1: 'Dịch Vụ Giặt Ủi Di Động',
      title2: 'Cá Nhân Hóa, Uy Tín',
      title3: '& Chuyên Nghiệp.',
      sub1: 'Nhận & giao hàng tận nơi trong vòng 24 giờ.',
      sub2: 'Tươi mới, sạch sẽ & tiện lợi — đúng lúc bạn cần!',
      sub3: '',
      subtitle: 'Nhận & giao hàng tận nơi trong vòng 24 giờ. Quần áo luôn tươi mới, sạch sẽ & tiện lợi — đúng lúc bạn cần!',
    ...
    reviews: {
      overline: 'Đánh Giá & Phản Hồi',
      badgeScore: 'Chất Lượng 5★',
      badgeCount: 'Không Gian Đánh Giá',
      title: "Xem Khách Hàng Nói Gì Về Dịch Vụ Giặt Ủi TLaundry",
      subtitle: 'Chúng tôi luôn lắng nghe và sẵn sàng phục vụ với chất lượng tận tâm nhất.',
      btnQuote: 'Yêu Cầu Báo Giá Miễn Phí Ngay Hôm Nay',
      placeholderSlot1Title: 'Dành Cho Đánh Giá Của Bạn',
      placeholderSlot2Title: 'Không Gian Trải Nghiệm Thực Tế',
      placeholderSlot3Title: 'Cảm Nhận Từ Khách Hàng',
      placeholderSlotDesc: 'Vị trí này đang chờ đón đánh giá thực tế từ bạn sau khi trải nghiệm dịch vụ giặt ủi giao nhận của TLaundry.',
      placeholderBtn: 'Gửi Đánh Giá Của Bạn',
      placeholderGuest: 'Khách hàng tương lai',
      placeholderCity: 'Sài Gòn, TP.HCM',
      placeholderTag: 'Vị trí mở',
      modalTitle: 'Gửi Đánh Giá Của Bạn',
      modalSubtitle: 'Chia sẻ cảm nhận chân thực về dịch vụ giặt ủi TLaundry',
      nameLabel: 'Họ và tên *',
      locationLabel: 'Khu vực / Quận *',
      ratingLabel: 'Mức độ hài lòng *',
      commentLabel: 'Nội dung đánh giá *',
      tagLabel: 'Loại khách hàng',
      btnSubmit: 'Gửi Đánh Giá Ngay',
      thankTitle: '🎉 Cảm ơn bạn rất nhiều!',
      thankDesc: 'Đánh giá của bạn đã được ghi nhận. Ý kiến đóng góp của bạn là động lực để TLaundry không ngừng nâng cao chất lượng dịch vụ!',
      btnClose: 'Đóng',
    },
    whoWeAre: {
      badge: "Về TLaundry",
    ...
    bookingPage: {
      ...
      detailsTitle: 'Thông Tin Cá Nhân & Tùy Chọn Giặt Xả',
      detailsSubtitle: 'Vui lòng cung cấp thông tin liên hệ, lựa chọn bột giặt xả và phương thức giao nhận.',
      firstName: 'Tên',
      lastName: 'Họ',
      email: 'Địa chỉ Email',
      phone: 'Số điện thoại',
      address: 'Địa chỉ nhà & Khu vực giao nhận (Số nhà, tên đường, phường/quận)',
      detergentTitle: 'Chọn Mẫu Nước Giặt / Bột Giặt',
      detergentSubtitle: 'Sử dụng các dòng nước giặt sinh học & hương nước hoa cao cấp, an toàn cho mọi loại vải.',
      softenerTitle: 'Chọn Mùi Hương Nước Xả Vải',
      softenerSubtitle: 'Lưu giữ hương thơm tinh tế, mềm mại và chống tĩnh điện sợi vải.',
      deliveryTitle: 'Phương Thức Giao Nhận',
      deliverySubtitle: 'Lựa chọn tốc độ nhận & trả đồ phù hợp với nhu cầu của bạn.',
      standardDelivery: 'Giao Nhận Tiêu Chuẩn (24 Giờ)',
      standardDeliveryDesc: 'Giặt sấy, là phẳng, gấp gọn và giao trả tận nơi trong vòng 24 giờ.',
      standardFee: 'Miễn phí',
      expressDelivery: 'Giao Hàng Cấp Tốc (4 - 6 Giờ)',
      expressDeliveryDesc: 'Ưu tiên giặt sấy riêng biệt ngay lập tức và giao hỏa tốc tận nơi trong ngày.',
      expressFee: '+30.000₫',
      expressTag: '⚡ Hỏa Tốc',
      notes: 'Ghi chú thêm',
      notesPlaceholder: 'Ví dụ: giặt riêng đồ trắng, giao trước 17h, gửi đồ tại quầy lễ tân...',
      btnContinue: 'Tiếp Tục →',
      btnBack: '← Quay Lại',
      btnReview: 'Xem Lại Yêu Cầu →',
      btnSubmit: 'Gửi Yêu Cầu Báo Giá ✓',
      confirmTitle: 'Xác Nhận Yêu Cầu Của Bạn',
      confirmSubtitle: 'Vui lòng kiểm tra kỹ thông tin và các tùy chọn trước khi gửi.',
      confirmService: 'Dịch vụ',
      confirmCustomer: 'Khách hàng',
      confirmEmail: 'Email',
      confirmPhone: 'Số điện thoại',
      confirmAddress: 'Địa chỉ nhận hàng',
      confirmDetergent: 'Nước giặt / Bột giặt',
      confirmSoftener: 'Nước xả vải',
      confirmDelivery: 'Phương thức giao nhận',
      confirmExpressFee: 'Phụ phí hỏa tốc',
      confirmNotes: 'Ghi chú thêm',
  ...
  en: {
    ...
    hero: {
      title1: 'Personalised Mobile',
      title2: 'Laundry Service,',
      title3: 'Professionally Trusted.',
      sub1: 'Fast pick-up & delivery all within 24 hours.',
      sub2: 'Fresh, clean & convenient — right when you need!',
      sub3: '',
      subtitle: 'Fast pick-up & delivery within 24 hours. Fresh, clean & convenient — right when you need!',
    ...
    reviews: {
      overline: 'Customer Reviews & Feedback',
      badgeScore: '5★ Quality',
      badgeCount: 'Review Space',
      title: "See What Our Customers Are Saying About TLaundry",
      subtitle: 'We value every single piece of feedback and strive to deliver outstanding laundry care.',
      btnQuote: 'Request A Free Quote Today',
      placeholderSlot1Title: 'Reserved For Your Review',
      placeholderSlot2Title: 'Authentic Experience Slot',
      placeholderSlot3Title: 'Customer Feedback Space',
      placeholderSlotDesc: 'This slot is reserved for authentic customer reviews after experiencing our laundry pickup & delivery service.',
      placeholderBtn: 'Submit Your Review',
      placeholderGuest: 'Future Customer',
      placeholderCity: 'Sài Gòn, Vietnam',
      placeholderTag: 'Open Slot',
      modalTitle: 'Submit Your Review',
      modalSubtitle: 'Share your genuine experience with TLaundry services',
      nameLabel: 'Full Name *',
      locationLabel: 'Location / District *',
      ratingLabel: 'Your Rating *',
      commentLabel: 'Review Content *',
      tagLabel: 'Customer Type',
      btnSubmit: 'Submit Review Now',
      thankTitle: '🎉 Thank You So Much!',
      thankDesc: 'Your review has been recorded. Your valuable feedback inspires TLaundry to continuously improve!',
      btnClose: 'Close',
    },
    whoWeAre: {
    ...
    bookingPage: {
      ...
      step1: 'Service Type',
      step2: 'Details & Preferences',
      step3: 'Confirmation',
      selectServiceTitle: 'What service do you need?',
      selectServiceSubtitle: 'Select the laundry service that best suits your needs.',
      detailsTitle: 'Your Details & Laundry Preferences',
      detailsSubtitle: 'Please provide your contact details, laundry detergent preferences, and delivery option.',
      firstName: 'First Name',
      lastName: 'Last Name',
      email: 'Email Address',
      phone: 'Phone Number',
      address: 'Street Address & Delivery Area (House number, street, ward/district)',
      detergentTitle: 'Select Detergent / Wash Formula',
      detergentSubtitle: 'Premium bio-based & luxury scented detergents, gentle on fabrics and skin.',
      softenerTitle: 'Select Fabric Softener Scent',
      softenerSubtitle: 'Infuse long-lasting delicate fragrance and anti-static softness into fabrics.',
      deliveryTitle: 'Delivery Option',
      deliverySubtitle: 'Choose the pickup & delivery speed that fits your schedule.',
      standardDelivery: 'Standard Delivery (24 Hours)',
      standardDeliveryDesc: 'Washed, dried, neatly folded and delivered to your door within 24 hours.',
      standardFee: 'Free',
      expressDelivery: 'Express Priority Delivery (4 - 6 Hours)',
      expressDeliveryDesc: 'Priority individual processing immediately with same-day express return.',
      expressFee: '+$10.00 / +30.000₫',
      expressTag: '⚡ Express',
      notes: 'Additional Notes',
      notesPlaceholder: 'E.g., wash whites separately, deliver before 5pm, leave at concierge...',
      btnContinue: 'Continue →',
      btnBack: '← Back',
      btnReview: 'Review Quote →',
      btnSubmit: 'Submit Quote Request ✓',
      confirmTitle: 'Confirm Your Request',
      confirmSubtitle: 'Please review your details and selected options before submitting.',
      confirmService: 'Service',
      confirmCustomer: 'Customer Name',
      confirmEmail: 'Email',
      confirmPhone: 'Phone Number',
      confirmAddress: 'Delivery Address',
      confirmDetergent: 'Detergent Formula',
      confirmSoftener: 'Fabric Softener',
      confirmDelivery: 'Delivery Speed',
      confirmExpressFee: 'Express Surcharge',
