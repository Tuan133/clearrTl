...
export const translations = {
  vi: {
    ...
    hero: {
      ...
      sub1: 'Chúng tôi Nhận & Giao hàng',
      sub2: 'tận nơi trong vòng 24 giờ',
      sub3: 'tươi mới, sạch sẽ & tiện lợi — đúng lúc bạn cần!',
  ...
  en: {
    ...
    hero: {
      ...
      sub1: 'We Pick-up & Deliver',
      sub2: 'all within 24 hours -',
      sub3: 'fresh, clean & convenient — exactly when you need!',
